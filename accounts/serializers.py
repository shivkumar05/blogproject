...
class User_Post_serializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Post
        fields =['user','post_name','tag_name','post_header','post_content','images','document','likes','created_date','update_date','is_active','comment_set']


class BlogSerializer(serializers.ModelSerializer):
    class Meta:
        model = Blog
        fields = ['user','tag_name','blog_name','blog_content','cover','created_date','update_date']
